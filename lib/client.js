  ...
  const ApprovalDetail = (props) => {
    ...
    return React.createElement('div', { className: 'adf-detail' },
      ...
      staleOperand ? React.createElement('div', { className: 'adf-detail-warn' },
        'The edit\u2019s old text was not found in the current file — the model may be working from a stale read. Review carefully.') : null,
      armed ? React.createElement('div', { className: 'adf-detail-armed' },
        React.createElement('span', null, 'armed — edits to this file auto-allow for this session'),
        React.createElement('button', {
          type: 'button', className: 'adf-detail-disarm', title: 'Stop auto-allowing this file',
          onClick: () => { armedByPath.delete(absolutePath); props.bumpArmed() },
        }, 'disarm')) : null,
